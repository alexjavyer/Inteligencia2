 ...
 * @author ALEX JAVIER
 */
public class tosMoco extends javax.swing.JFrame {
    ...
    public tosMoco() {
        initComponents();
          lblPregunta.setText("Presenta Tos con Moco");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado = regla.obtenerTosMoco(jComboBox1.getSelectedItem().toString());
        JOptionPane.showMessageDialog(null, resultado);
        if(resultado == "dificultadrespirar"){
            this.dispose();
            dificultadRespirar fi = new dificultadRespirar();
            fi.show();
            
        }else{
            this.dispose();
            dolorGarganta fi = new dolorGarganta();
            fi.show();
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tosMoco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
