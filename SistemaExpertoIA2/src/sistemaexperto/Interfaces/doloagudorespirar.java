 ...
 * @author ALEX JAVIER
 */
public class doloagudorespirar extends javax.swing.JFrame {
    ...
    public doloagudorespirar() {
        initComponents();
          lblPregunta.setText("Dolor agudo cuando respira");
    }
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(doloagudorespirar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new doloagudorespirar().setVisible(true);
            }
        });
    }
