 ...
 * @author ALEX JAVIER
 */
public class dolorGarganta extends javax.swing.JFrame {
    ...
    public dolorGarganta() {
        initComponents();
          lblPregunta.setText("Dolor de garganta");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado = regla.obtenerDolorGarganta(jComboBox1.getSelectedItem().toString());
          JOptionPane.showMessageDialog(null, resultado);
        if(resultado == "dificultadRespirar"){
           this.dispose();
            dificultadRespirar1 fi = new dificultadRespirar1();
            fi.show();
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dolorGarganta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dolorGarganta().setVisible(true);
            }
        });
    }
