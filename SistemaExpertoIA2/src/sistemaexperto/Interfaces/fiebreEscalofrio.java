 ...
 * @author ALEX JAVIER
 */
public class fiebreEscalofrio extends javax.swing.JFrame {
    ...
    public fiebreEscalofrio() {
        initComponents();
          lblPregunta.setText("Presenta sintomas de Fiebre");
    }
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fiebreEscalofrio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fiebreEscalofrio().setVisible(true);
            }
        });
    }
