...
public class pregunta2 extends javax.swing.JFrame {
    ...
    public pregunta2() {
        initComponents();
          lblPregunta.setText("Presenta fiebre dolores, escalofrios, mucosidad");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado = regla.obtenerTieneEscalofrioMucosidad(jComboBox1.getSelectedItem().toString());
         JOptionPane.showMessageDialog(null, "tosseca   "+resultado);
        
        if(resultado == "dificultadRespiracion"){
           this.dispose();    
            faltaRespiracion fi = new faltaRespiracion();
            fi.show();
            
        }else{
            JOptionPane.showMessageDialog(null, "tos con flema  "+resultado);
 
            this.dispose();
            tosFlema fi = new tosFlema();
            fi.show();
