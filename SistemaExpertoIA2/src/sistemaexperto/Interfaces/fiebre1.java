 ...
 * @author ALEX JAVIER
 */
public class fiebre1 extends javax.swing.JFrame {
    ...
    public fiebre1() {
        initComponents();
          lblPregunta.setText("Tiene fiebre");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado = regla.obtenerFiebre(jComboBox1.getSelectedItem().toString());
        JOptionPane.showMessageDialog(null, "falt res   "+resultado);
        
        if(resultado == "condiciones"){
           this.dispose();    
            fiebre fi = new fiebre();
            fi.show();
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fiebre1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
