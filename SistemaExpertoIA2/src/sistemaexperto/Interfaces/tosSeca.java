 ...
 * @author ALEX JAVIER
 */
public class tosSeca extends javax.swing.JFrame {
    ...
    public tosSeca() {
        initComponents();
          lblPregunta.setText("Tiene Tos Seca");
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        resultado = regla.obtenerTosSeca(jComboBox1.getSelectedItem().toString());
        JOptionPane.showMessageDialog(null, "tosseca   "+resultado);
        
        if(resultado == "dificultadrespirar"){
           this.dispose();    
            dolorPecho1 fi = new dolorPecho1();
            fi.show();
            
        }else{
            this.dispose();
            dolorPecho2 fi = new dolorPecho2();
            fi.show();
   ...
   //     botonClick++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tosSeca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
